...
const optionDefinitions = [
  ...
  {
    name: 'manifest-file',
    defaultValue: path.join(rootDir, 'manifest.json'),
    type: String,
    description: 'Manifest to read and write from. Defaults to ./manifest.json.',
    group: 'output',
  ...
  },
  {
    ...
    defaultOption: true,
    defaultValue: path.join(rootDir, 'definitions.js'),
    type: String,
    description: 'File with definition to use for loading pages. Defaults to ./definitions.js.',
    group: 'browser',
    typeLabel: '{underline path}',
  },
  {
...
const definitions = require(options.definitionsFile);
